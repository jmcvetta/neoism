...
```go
// res will be populated with the results of the query.  It must be a slice of structs.
res := []struct {
...
// cq holds the Cypher query itself, any parameters it may have, and a result object.
